...
13. [V9 重构优化方案](优化重构/重构优化_v9/re_optimization_v9.md)
14. [V9 真实 Telegram 场景验收 Runbook](优化重构/重构优化_v9/真实Telegram场景验收Runbook_v9.md)
...
- V9 以后，Telegram 图片正常成功路径以数据库增量 upsert 和目标日期 Markdown 合并为主；表结构本轮没有新增强制 SQL。
