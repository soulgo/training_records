...
| 站点生成 | `tools/generate-training-data.mjs:32,83` |
...
| Infra / Jobs | `src/infra`、`src/jobs` | 配置和任务包装。 |
| Tools | `tools` | CLI、维护脚本、兼容入口。 |
...
| 飞书同步 | `npm run sync:feishu` | `tools/feishu-sync.mjs` -> `src/app/use-cases/feishu-sync.use-case.mjs` |
