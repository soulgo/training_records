...
| 随想处理 | `src/app/use-cases/message-sync-thoughts.mjs` 中 `handleThoughtSyncBatch` |
| Markdown 附件正文 | `src/app/use-cases/message-sync-thoughts.mjs` 中 `prepareThoughtMarkdownBody` |
| 图片写入 | `src/app/use-cases/message-sync-thoughts.mjs` 中 `writeThoughtArtifact` |
