  ...
  return days.flatMap((day) =>
    (day.sleep ?? []).map((sleep) => {
      ...
      return {
        ...
        bedtime,
        wakeTime,
        nightSleepMinutes: sleep.nightSleepMinutes != null ? Math.round(Number(sleep.nightSleepMinutes)) : null,
        totalSleepMinutes: sleep.totalSleepMinutes != null ? Math.round(Number(sleep.totalSleepMinutes)) : null,
        napMinutes: sleep.napMinutes != null ? Math.round(Number(sleep.napMinutes)) : null,
        deepSleepMinutes: sleep.deepSleepMinutes != null ? Math.round(Number(sleep.deepSleepMinutes)) : null,
        lightSleepMinutes: sleep.lightSleepMinutes != null ? Math.round(Number(sleep.lightSleepMinutes)) : null,
        remSleepMinutes: sleep.remSleepMinutes != null ? Math.round(Number(sleep.remSleepMinutes)) : null,
        awakeMinutes: sleep.awakeMinutes != null ? Math.round(Number(sleep.awakeMinutes)) : null,
        ...
        sleepScore: sleep.sleepScore != null ? Math.round(Number(sleep.sleepScore)) : null,
        sleepScorePercentile: sleep.sleepScorePercentile != null ? Math.round(Number(sleep.sleepScorePercentile)) : null,
        ...
        deepSleepContinuityScore: sleep.deepSleepContinuityScore != null ? Math.round(Number(sleep.deepSleepContinuityScore)) : null,
        wakeCount: sleep.wakeCount != null ? Math.round(Number(sleep.wakeCount)) : null,
        breathingQualityScore: sleep.breathingQualityScore != null ? Math.round(Number(sleep.breathingQualityScore)) : null,
        averageHeartRateBpm: sleep.averageHeartRateBpm != null ? Math.round(Number(sleep.averageHeartRateBpm)) : null,
        hrvMs: sleep.hrvMs != null ? Math.round(Number(sleep.hrvMs)) : null,
